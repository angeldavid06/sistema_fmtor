<div class="tarjeta-transparente menu-principal">
    ...
    <div class="d-grid g-3">
        ...
        <a class="btn btn-transparent" href="<?php echo $this->url_server; ?>/usuario/control">
            <div class="d-grid g-1">
        ...
        <a class="btn btn-transparent" href="<?php echo $this->url_server; ?>/usuario/diario">
            <div class="d-grid g-1">
        ...
        <a class="btn btn-transparent" href="<?php echo $this->url_server; ?>/usuario/maquinas">
            <div class="d-grid g-1">
        ...
        <a class="btn btn-transparent" href="<?php echo $this->url_server; ?>/usuario/estados">
            <div class="d-grid g-1">
