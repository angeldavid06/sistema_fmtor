...
<nav class="opciones">
    <a href="<?php echo $this->url_server; ?>/usuario/programa">
        <i class="material-icons-round">format_list_bulleted</i>
        Programa de Forjado
    </a>
    <a href="<?php echo $this->url_server; ?>/usuario/explosion">
        <i class="material-icons-round">scale</i>
        Explosión de Alambre
    </a>
    <a href="<?php echo $this->url_server; ?>/usuario/ordenes">
        <i class="material-icons-round">engineering</i>
        Ordenes de Producción
    </a>
    <a href="<?php echo $this->url_server; ?>/usuario/control">
        <i class="material-icons-round">supervisor_account</i>
        Control de Producción
    </a>
    <a href="<?php echo $this->url_server; ?>/usuario/diario">
        <i class="material-icons-round">today</i>
        Registro Diario de Producción
    </a>
    <a href="<?php echo $this->url_server; ?>/usuario/maquinas">
        <i class="material-icons-round">precision_manufacturing</i>
        Máquinas de Producción
    </a>
    <a href="<?php echo $this->url_server; ?>/usuario/estados">
