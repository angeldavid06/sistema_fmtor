...
<div id="modal-actualizar-salida" class="modal modal-derecha">
    <div class="titulo_modal d-flex justify-between align-content-center">
        ...
        <button style="margin: 0px;" class="btn btn-icon-self btn-transparent material-icons" id="close_modal" data-modal="modal-actualizar-salida">close</button>
    </div>
    <div class="contenido_modal">
...
<div id="modal-historial" class="modal modal-izquierda width-05">
    ...
    <div class="d-flex justify-right align-content-center">
        <button style="margin: 0px;" class="btn btn-icon-self material-icons">add</button>
    </div>
    <div class="contenido_modal">
        <div class="d-grid g-1">
