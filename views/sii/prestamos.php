                            ...
                            <div class="periodo d-grid g2-9-1">
                                <div class="d-flex justify-between">
                                        <div class="flex-column justu">
                                            <label for="f_empleado">Empleado:</label>
                                            <input type="number" name="f_empleado" id="f_empleado">
                                        </div>
                                        <div class="flex-column justu">
                                        ...
                                        <div class="flex-column justu">
                                            <label for="f_interes">Interes:</label>
                                            <input type="number" name="f_interes" id="f_interes">
                                        </div>
                                </div>
