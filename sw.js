const CACHE_NAME = "fmtor_rdg_v1.1",
  urlsToCache = [
    ...
    "http://localhost/sistema_fmtor/public/js/produccion/control.js",
    "http://localhost/sistema_fmtor/public/js/produccion/diario.js",
    "http://localhost/sistema_fmtor/public/js/produccion/estado_op.js",
    "http://localhost/sistema_fmtor/public/js/produccion/estados.js",
    "http://localhost/sistema_fmtor/public/js/produccion/filtros.js",
    "http://localhost/sistema_fmtor/public/js/produccion/maquinas.js",
    "http://localhost/sistema_fmtor/public/js/produccion/ordenes.js",
    "http://localhost/sistema_fmtor/public/js/produccion/programa_forjado.js",
    "http://localhost/sistema_fmtor/public/js/produccion/prueba.js",
    "http://localhost/sistema_fmtor/public/js/produccion/render_control_admin.js",
    "http://localhost/sistema_fmtor/public/js/produccion/render_control_usuario.js",
    "http://localhost/sistema_fmtor/public/js/produccion/render_diario_admin.js",
    "http://localhost/sistema_fmtor/public/js/produccion/render_diario_usuario.js",
    "http://localhost/sistema_fmtor/public/js/produccion/render_programa_forjado_admin.js",
    "http://localhost/sistema_fmtor/public/js/produccion/render_programa_forjado_usuario.js",
